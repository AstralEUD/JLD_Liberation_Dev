...
if (isNil "Respawn_truck_typename")
	then {
		Respawn_truck_typename = "B_APC_Tracked_01_rcws_F";
	};
...
heavy_vehicles = [
	...
	["B_APC_Tracked_01_AA_F", 200, 160, 0],
	["I_MBT_03_cannon_F", 250, 180, 0],
	["B_MBT_01_cannon_F", 250, 180, 0],
	["B_MBT_01_TUSK_F", 250, 200, 0],
	["B_MBT_01_arty_F", 100, 100, 100]
];
...
air_vehicles = [
	...
	["B_UAV_01_F", 0, 50, 20],
	["B_UAV_02_F", 0, 100, 30],
	["B_UAV_02_CAS_F", 0, 150, 30],
	["B_UAV_05_F", 0, 100, 150],
	["B_T_UAV_03_F", 0, 200, 100]
];
...
buildings = [
	...
	["Land_Missle_Trolley_01_F", 0, 0, 0],
