...
1.공수강하 비용이 30으로 증가하였습니다.

2.항공기를 이용한 공수강하의 최소고도가 300m로 완화되었습니다. 또한, 가방이 사라지는 버그가 수정되었습니다.

3.리스폰시 전술통신망 상태를 유지하도록 수정하였습니다. (조종사는 항상 가입)

4.특수임무를 생성할 수 없는 경우 안내문과 함께 투입한 정보량 만큼의 위협도가 곱연산으로 감소하도록 수정하였습니다.
</font>
"]]];
