...
1.항공장비를 이용해서 단독으로 공격임무를 수행할 수 없습니다. 단, 방어임무는 단독으로 수행가능합니다.<br/>
...
3.유지비용이 시간당 500으로 증가하였습니다.<br/><br/>

4.공수강하시 250m상공에서 자동으로 낙하산이 펼쳐지도록 수정되었습니다. <font color='#FF0000'>죽디말라!</font><br/><br/>
