...
if (isNil "NreEarplugsActive") then {
	NreEarplugsActive = 0;
	1 fadeSound 1;		
	_id = player addAction [("<t color=""#ff00ff"">" + (localize "STR_NREEP_IN_ACTION") +"</t>"),NreEarplugsPath+"NRE_earplugs.sqf","",5,false,true,"User1",""];
	...
	player addEventHandler ["Respawn", {
		...
		_id = (_this select 0) addAction [("<t color=""#ff00ff"">" + (localize "STR_NREEP_IN_ACTION") +"</t>"),NreEarplugsPath+"NRE_earplugs.sqf","",5,false,true,"User1",""];
...
if ( NreEarplugsActive == 1 ) then {
	...
	_id = player getVariable "NreEarplugsAction";
	player removeAction _id;
	_id = player addAction [("<t color=""#FF0000"">" + (localize "STR_NREEP_OUT_ACTION") +"</t>"),NreEarplugsPath+"NRE_earplugs.sqf","",5,false,true,"User1",""];
	player setVariable ["NreEarplugsAction", _id];
};
