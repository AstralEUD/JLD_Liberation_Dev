...
#define STR_TOSS_ROPES "강하로프 내리기"
#define STR_FAST_ROPE "레펠강하"
#define STR_CUT_ROPES "로프끊기"

#define STR_JOIN_QUEUE_HINT "강하 순서 대기중!"
...
SHK_Fastrope_Helis = [
  ...
  ["C_IDAP_Heli_Transport_02_F",["CargoRamp_Open"],[[0,-5,0]]], // IDAP Mohawk
