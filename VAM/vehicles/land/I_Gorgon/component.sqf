//I_APC_Wheeled_03_cannon_F Components
...
_subsel3 = localize "STR_VAM_EXTERNAL_BAG_2_COMP";
...
if (selectcomp isEqualTo 1) exitWith {[_targetvehicle,nil,[true],nil] call BIS_fnc_initVehicle; [] spawn fnc_Gorgon_comp; sleep 2; hint "";};

if (selectcomp isEqualTo 7) exitWith {
	[_targetvehicle,nil,["showCamonetHull",1,"showBags",1,"showBags2",1,"showTools",1,"showSLATHull",1],nil] call BIS_fnc_initVehicle;
	[] spawn fnc_Gorgon_comp; sleep 2; hint "";
};
...
if (true) then {
	[_targetvehicle,nil,["showCamonetHull",_op1,"showBags",_op2,"showBags2",_op3,"showTools",_op4,"showSLATHull",_op5],nil] call BIS_fnc_initVehicle;
	[] spawn fnc_Gorgon_comp; sleep 2; hint "";
};