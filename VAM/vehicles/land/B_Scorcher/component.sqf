//B_Scorcher Components
//[["Sand",1],["showCanisters",0,"showCamonetTurret",0,"showAmmobox",0,"showCamonetHull",0]]
selectcomp = 0;
...
_subsel4 = localize "STR_VAM_CANISTERS_COMP";
_VAM_comp =
[
	[_subname,false],
...
if (selectcomp isEqualTo 1) exitWith {[_targetvehicle,nil,[true],nil] call BIS_fnc_initVehicle; [] spawn fnc_Scorcher_comp; sleep 2; hint "";};

if (selectcomp isEqualTo 6) exitWith {
	[_targetvehicle,nil,["showCanisters",1,"showCamonetTurret",1,"showAmmobox",1,"showCamonetHull",1],nil] call BIS_fnc_initVehicle;
	[] spawn fnc_Scorcher_comp; sleep 2; hint "";
};

if (selectcomp isEqualTo 2) then {
	if (_check select 7 isEqualTo 0) then {_op1 = 1;};
	if (_check select 7 isEqualTo 1) then {_op1 = 0;};
};
...
if (true) then {
	[_targetvehicle,nil,["showCanisters",_op4,"showCamonetTurret",_op2,"showAmmobox",_op3,"showCamonetHull",_op1],nil] call BIS_fnc_initVehicle;
	[] spawn fnc_Scorcher_comp; sleep 2; hint "";
};