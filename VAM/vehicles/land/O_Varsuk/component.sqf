//O_Varsuk Components
//[["Hex",1],["showCamonetHull",0,"showCamonetTurret",0,"showLog",0]]
selectcomp = 0;
...
_subsel3 = localize "STR_VAM_WOOD_LOG_COMP";
_VAM_Comp =
[
	[_subname,false],
...
if (selectcomp isEqualTo 1) exitWith {[_targetvehicle,nil,[true],nil] call BIS_fnc_initVehicle; [] spawn fnc_Varsuk_comp; sleep 2; hint "";};

if (selectcomp isEqualTo 5) exitWith {
	[_targetvehicle,nil,["showCamonetHull",1,"showCamonetTurret",1,"showLog",1],nil] call BIS_fnc_initVehicle;
	[] spawn fnc_Varsuk_comp; sleep 2; hint "";
};
...
if (true) then {
	[_targetvehicle,nil,["showCamonetHull",_op1,"showCamonetTurret",_op2,"showLog",_op3],nil] call BIS_fnc_initVehicle;
	[] spawn fnc_Varsuk_comp; sleep 2; hint "";
};