...
_subsel3 = localize "STR_VAM_TOOLS_COMP";
...
if (selectcomp isEqualTo 1) exitWith {[_targetvehicle,nil,[true],nil] call BIS_fnc_initVehicle; [] spawn fnc_Nyx_comp; sleep 2; hint "";};

if (selectcomp isEqualTo 6) exitWith {
	[_targetvehicle,nil,["showTools",1,"showCamonetHull",1,"showBags",1,"showSLATHull",1],nil] call BIS_fnc_initVehicle;
	[] spawn fnc_Nyx_comp; sleep 2; hint "";
};
...
if (true) then {
	[_targetvehicle,nil,["showTools",_op3,"showCamonetHull",_op1,"showBags",_op2,"showSLATHull",_op4],nil] call BIS_fnc_initVehicle;
	[] spawn fnc_Nyx_comp; sleep 2; hint "";
};