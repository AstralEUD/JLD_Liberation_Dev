//O_Tigris Components
//[["Hex",1],["showTracks",0,"showCamonetHull",0,"showCamonetTurret",0,"showSLATHull",0]]
selectcomp = 0;
...
_subsel3 = localize "STR_VAM_EXTRA_TRACK_COMP";
...
if (selectcomp isEqualTo 1) exitWith {[_targetvehicle,nil,[true],nil] call BIS_fnc_initVehicle; [] spawn fnc_Tigris_comp; sleep 2; hint "";};

if (selectcomp isEqualTo 6) exitWith {
	[_targetvehicle,nil,["showTracks",1,"showCamonetHull",1,"showCamonetTurret",1,"showSLATHull",1],nil] call BIS_fnc_initVehicle;
	[] spawn fnc_Tigris_comp; sleep 2; hint "";
};
...
if (true) then {
	[_targetvehicle,nil,["showTracks",_op3,"showCamonetHull",_op1,"showCamonetTurret",_op2,"showSLATHull",_op4],nil] call BIS_fnc_initVehicle;
	[] spawn fnc_Tigris_comp; sleep 2; hint "";
};