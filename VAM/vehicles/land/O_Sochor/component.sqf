//O_Sochor Components
//[["Hex",1],["showAmmobox",0,"showCanisters",0,"showCamonetTurret",0,"showCamonetHull",0,"showLog",0]]
selectcomp = 0;
...
_subsel5 = localize "STR_VAM_WOOD_LOG_COMP";
_VAM_Comp =
[
	[_subname,false],
...
if (selectcomp isEqualTo 1) exitWith {[_targetvehicle,nil,[true],nil] call BIS_fnc_initVehicle; [] spawn fnc_Sochor_comp; sleep 2; hint "";};

if (selectcomp isEqualTo 7) exitWith {
	[_targetvehicle,nil,["showAmmobox",1,"showCanisters",1,"showCamonetTurret",1,"showCamonetHull",1,"showLog",1],nil] call BIS_fnc_initVehicle;
	[] spawn fnc_Sochor_comp; sleep 2; hint "";
};
...
if (true) then {
	[_targetvehicle,nil,["showAmmobox",_op3,"showCanisters",_op4,"showCamonetTurret",_op2,"showCamonetHull",_op1,"showLog",_op5],nil] call BIS_fnc_initVehicle;
	[] spawn fnc_Sochor_comp; sleep 2; hint "";
};