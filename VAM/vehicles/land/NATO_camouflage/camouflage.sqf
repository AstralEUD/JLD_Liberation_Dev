//NATO_camouflage (Except Rhino, Prowler)
selectcamo = 0;
...
if (selectcamo isEqualTo 1) exitWith {[_targetvehicle,["Sand",1],nil,nil] call BIS_fnc_initVehicle; [] spawn fnc_NATO_camo; sleep 2; hint "";};

if (selectcamo isEqualTo 2) exitWith {[_targetvehicle,["Olive",1],nil,nil] call BIS_fnc_initVehicle; [] spawn fnc_NATO_camo; sleep 2; hint "";};