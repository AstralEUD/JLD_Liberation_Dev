...
_subsel2 = localize "STR_VAM_OPFOR_CAMO";
_VAM_camo =
[
	[_subname,false],
...
if (selectcamo isEqualTo 1) exitWith {[_targetvehicle,["Indep",1],nil,nil] call BIS_fnc_initVehicle; [] spawn fnc_Zamak_mil_camo; sleep 2; hint "";};
	
if (selectcamo isEqualTo 2) exitWith {[_targetvehicle,["OPFOR",1],nil,nil] call BIS_fnc_initVehicle; [] spawn fnc_Zamak_mil_camo; sleep 2; hint "";};