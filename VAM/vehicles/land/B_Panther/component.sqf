//B_Panther Components
//[["Sand",1],["showCamonetHull",0,"showBags",0]]
selectcomp = 0;
...
if (selectcomp isEqualTo 1) exitWith {[_targetvehicle,nil,[true],nil] call BIS_fnc_initVehicle; [] spawn fnc_Panther_comp; sleep 2; hint "";};

if (selectcomp isEqualTo 4) exitWith {
	[_targetvehicle,nil,["showCamonetHull",1,"showBags",1],nil] call BIS_fnc_initVehicle;
	[] spawn fnc_Panther_comp; sleep 2; hint "";
};
...
if (true) then {
	[_targetvehicle,nil,["showCamonetHull",_op1,"showBags",_op2],nil] call BIS_fnc_initVehicle;
	[] spawn fnc_Panther_comp; sleep 2; hint "";
};