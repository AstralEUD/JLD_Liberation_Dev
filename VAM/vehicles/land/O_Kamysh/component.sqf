//O_Kamysh Components
//[["Hex",1],["showTracks",0,"showCamonetHull",0,"showBags",0,"showSLATHull",0]]
selectcomp = 0;
...
if (selectcomp isEqualTo 1) exitWith {[_targetvehicle,nil,[true],nil] call BIS_fnc_initVehicle; [] spawn fnc_Kamysh_comp; sleep 2; hint "";};

if (selectcomp isEqualTo 6) exitWith {
	[_targetvehicle,nil,["showTracks",1,"showCamonetHull",1,"showBags",1,"showSLATHull",1],nil] call BIS_fnc_initVehicle;
	[] spawn fnc_Kamysh_comp; sleep 2; hint "";
};
...
if (true) then {
	[_targetvehicle,nil,["showTracks",_op3,"showCamonetHull",_op1,"showBags",_op2,"showSLATHull",_op4],nil] call BIS_fnc_initVehicle;
	[] spawn fnc_Kamysh_comp; sleep 2; hint "";
};