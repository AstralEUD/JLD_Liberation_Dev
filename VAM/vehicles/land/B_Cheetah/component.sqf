...
if (selectcomp isEqualTo 1) exitWith {[_targetvehicle,nil,[true],nil] call BIS_fnc_initVehicle; [] spawn fnc_Cheetah_comp; sleep 2; hint "";};

if (selectcomp isEqualTo 5) exitWith {
	[_targetvehicle,nil,["showCamonetTurret",1,"showCamonetHull",1,"showBags",1],nil] call BIS_fnc_initVehicle;
	[] spawn fnc_Cheetah_comp; sleep 2; hint "";
};
