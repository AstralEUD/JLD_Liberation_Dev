//B_T_MBT_01_cannon_TUSK_F Components
//[["Sand",1],["showBags",0,"showCamonetTurret",0,"showCamonetHull",0]]
//[["Sand",1],["showCamonetTurret",0,"showCamonetHull",0,"showBags",0]]
selectcomp = 0;
...
if (selectcomp isEqualTo 1) exitWith {[_targetvehicle,nil,[true],nil] call BIS_fnc_initVehicle; [] spawn fnc_Slammer_comp; sleep 2; hint "";};

if (selectcomp isEqualTo 5) exitWith {
	[_targetvehicle,nil,["showBags",1,"showCamonetTurret",1,"showCamonetHull",1],nil] call BIS_fnc_initVehicle;
	[] spawn fnc_Slammer_comp; sleep 2; hint "";
};

if (typeof _targetvehicle in ["B_MBT_01_cannon_F","B_T_MBT_01_cannon_F"]) then {
	...
	if (true) then {
	[_targetvehicle,nil,["showBags",_op3,"showCamonetTurret",_op2,"showCamonetHull",_op1],nil] call BIS_fnc_initVehicle;
	[] spawn fnc_Slammer_comp; sleep 2; hint "";
	};
};

if (typeof _targetvehicle in ["B_MBT_01_TUSK_F","B_T_MBT_01_TUSK_F"]) then {
	...
	if (true) then {
	[_targetvehicle,nil,["showCamonetTurret",_op2,"showCamonetHull",_op1,"showBags",_op3],nil] call BIS_fnc_initVehicle;
	[] spawn fnc_Slammer_comp; sleep 2; hint "";
	};
};