...
_subsel3 = localize "STR_VAM_CANISTERS_COMP";
_subsel4 = localize "STR_VAM_TOOLS_COMP";
_subsel5 = localize "STR_VAM_SLAT_ARMOR_HULL_COMP";
_VAM_Comp =
[
	[_subname,false],
...
private _op4 = _check select 5;
private _op5 = _check select 9;

if (selectcomp > 0) then {hint localize "STR_VAM_SUB_COMPONENT_APPLIED";};

if (selectcomp isEqualTo 1) exitWith {[_targetvehicle,nil,[true],nil] call BIS_fnc_initVehicle; [] spawn fnc_Marid_comp; sleep 2; hint "";};
...
if (selectcomp isEqualTo 7) exitWith {
	...
	[] spawn fnc_Marid_comp; sleep 2; hint "";
};
...
if (selectcomp isEqualTo 5) then {
	if (_check select 5 isEqualTo 0) then {_op4 = 1;};
	if (_check select 5 isEqualTo 1) then {_op4 = 0;};
};
...
if (true) then {
	[_targetvehicle,nil,["showBags",_op2,"showCanisters",_op3,"showTools",_op4,"showCamonetHull",_op1,"showSLATHull",_op5],nil] call BIS_fnc_initVehicle;
	[] spawn fnc_Marid_comp; sleep 2; hint "";
};