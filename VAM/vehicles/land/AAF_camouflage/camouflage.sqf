...
if (selectcamo isEqualTo 1) exitWith {[_targetvehicle,["Indep_01",1],nil,nil] call BIS_fnc_initVehicle; [] spawn fnc_AAF_camo; sleep 2; hint "";};
	
if (selectcamo isEqualTo 2) exitWith {[_targetvehicle,["Indep_02",1],nil,nil] call BIS_fnc_initVehicle; [] spawn fnc_AAF_camo; sleep 2; hint "";};
	
if (selectcamo isEqualTo 3) exitWith {[_targetvehicle,["Indep_03",1],nil,nil] call BIS_fnc_initVehicle; [] spawn fnc_AAF_camo; sleep 2; hint "";};