...
_subsel2 = localize "STR_VAM_GREY_CAMO";
_subsel3 = localize "STR_VAM_HEX_ARID_CAMO";
_VAM_camo =
[
	[_subname,false],
...
if (selectcamo isEqualTo 1) exitWith {
	[_targetvehicle,["Green",1],nil,nil] call BIS_fnc_initVehicle; [] spawn fnc_Buzzard_camo; sleep 2; hint "";
};
	
if (selectcamo isEqualTo 2) exitWith {
	[_targetvehicle,["Grey",1],nil,nil] call BIS_fnc_initVehicle; [] spawn fnc_Buzzard_camo; sleep 2; hint "";
};
	
if (selectcamo isEqualTo 3) exitWith {
	[_targetvehicle,["Hex",1],nil,nil] call BIS_fnc_initVehicle; [] spawn fnc_Buzzard_camo; sleep 2; hint "";
};