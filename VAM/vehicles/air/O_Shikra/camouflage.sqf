...
_subsel3 = localize "STR_VAM_BLUE_CAMO";
_VAM_camo =
[
	[_subname,false],
...
if (selectcamo isEqualTo 1) exitWith {
	[_targetvehicle,["CamoAridHex",1],nil,nil] call BIS_fnc_initVehicle; [] spawn fnc_Shikra_camo; sleep 2; hint "";
};
	
if (selectcamo isEqualTo 2) exitWith {
	[_targetvehicle,["CamoGreyHex",1],nil,nil] call BIS_fnc_initVehicle; [] spawn fnc_Shikra_camo; sleep 2; hint "";
};
	
if (selectcamo isEqualTo 3) exitWith {
	[_targetvehicle,["CamoBlue",1],nil,nil] call BIS_fnc_initVehicle; [] spawn fnc_Shikra_camo; sleep 2; hint "";
};