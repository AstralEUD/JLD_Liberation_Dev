//I_Gryphon Camouflage
//[["CamoGrey",1],[]]
selectcamo = 0;
_subname = localize "STR_VAM_SUB_CAMOUFLAGE";
_subback = localize "STR_VAM_SUB_BACK";
_subclose = localize "STR_VAM_CLOSE_MENU";
_subsel1 = localize "STR_VAM_DIGI_GREEN_CAMO";
_subsel2 = localize "STR_VAM_DIGI_GREY_CAMO";
_subsel3 = localize "STR_VAM_GREY_CAMO";
_VAM_camo =
[
	[_subname,false],
...
if (selectcamo isEqualTo 1) exitWith {
	[_targetvehicle,["DigitalCamoGreen",1],nil,nil] call BIS_fnc_initVehicle; [] spawn fnc_Gryphon_camo; sleep 2; hint "";
};
	
if (selectcamo isEqualTo 2) exitWith {
	[_targetvehicle,["DigitalCamoGrey",1],nil,nil] call BIS_fnc_initVehicle; [] spawn fnc_Gryphon_camo; sleep 2; hint "";
};
	
if (selectcamo isEqualTo 3) exitWith {
	[_targetvehicle,["CamoGrey",1],nil,nil] call BIS_fnc_initVehicle; [] spawn fnc_Gryphon_camo; sleep 2; hint "";
};