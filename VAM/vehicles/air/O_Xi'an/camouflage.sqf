...
if (selectcamo isEqualTo 1) exitWith {
	[_targetvehicle,["Hex",1],nil,nil] call BIS_fnc_initVehicle; [] spawn fnc_Xian_camo; sleep 2; hint "";
};
	
if (selectcamo isEqualTo 2) exitWith {
	[_targetvehicle,["GreenHex",1],nil,nil] call BIS_fnc_initVehicle; [] spawn fnc_Xian_camo; sleep 2; hint "";
};
	
if (selectcamo isEqualTo 3) exitWith {
	[_targetvehicle,["Grey",1],nil,nil] call BIS_fnc_initVehicle; [] spawn fnc_Xian_camo; sleep 2; hint "";
};