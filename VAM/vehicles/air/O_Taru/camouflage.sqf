...
if (selectcamo isEqualTo 1) exitWith {
	[_targetvehicle,["Opfor",1],nil,nil] call BIS_fnc_initVehicle; [] spawn fnc_Taru_camo; sleep 2; hint "";
};
	
if (selectcamo isEqualTo 2) exitWith {
	[_targetvehicle,["Black",1],nil,nil] call BIS_fnc_initVehicle; [] spawn fnc_Taru_camo; sleep 2; hint "";
};