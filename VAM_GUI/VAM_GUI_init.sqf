...
//Options
VAM_check_fob_on = true; //Set to true if you want Liberation FOB check feature.
VAM_fob_radius = GRLIB_fob_range; //FOB radius
...
fnc_VAM_fob_check = compileFinal preprocessFileLineNumbers "VAM_GUI\functions\fnc_VAM_fob_check.sqf";
