...
GRLIB_radiotower_size = 1000;
GRLIB_recycling_percentage = 0.70;
GRLIB_endgame = 0;
GRLIB_vulnerability_timer = 900;	//900
GRLIB_defended_buildingpos_part = 0.7;
